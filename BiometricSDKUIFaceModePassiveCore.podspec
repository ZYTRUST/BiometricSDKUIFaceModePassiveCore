Pod::Spec.new do |s|
  ...
  s.author       = "Idemia"
  s.platform     = :ios, "11.0"
  s.source       = { :git => "https://github.com/ZYTRUST/BiometricSDKUIFaceModePassiveCore.git", :tag => "2.3.9" }

  s.requires_arc = true
  s.vendored_frameworks = "Sources/BiometricSDKUIFaceModePassiveCore.xcframework"
